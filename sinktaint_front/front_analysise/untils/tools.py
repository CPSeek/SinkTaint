...
from front_analysise.modules.parameter import Keyword
import re
import datetime
...
class AnalysisBinary(object):
    ...
    def get_string(self): #comment: use the linux tool 'strings' to get string in the binary file
...
if __name__ == "__main__":
    ...
    ana = AnalysisBinary("/Users/gh0st/Ghidra_Project/httpd")
    keyw = [Keyword("enable", '')]
    #res = ana([["enable", ""]])
    res = ana(keyw)
