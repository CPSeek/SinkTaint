...
# 删除常见的命令，不会发起http请求的
# SPECIAL_COMMAND = ['ls', "pwd", "cat", "vim", "whoami", "printf", "cp", "which", 
#                    "top", "echo", "ps", "unzip", "fdisk", "sleep", "kill", "vi",
#                    "mkdir", "touch","ifconfig", "grep","df", "uname", "awk", "chmod", 
#                    "find","ln", "netstat","mv", "ssh-keygen", "wget", "curl", "busybox"]
SPECIAL_COMMAND = ['ls', "pwd", "cat", "vim", "whoami", "printf", "cp", "which", 
                   "top", "echo", "ps", "unzip", "fdisk", "sleep", "kill", "vi",
                   "mkdir", "touch","ifconfig", "grep","df", "uname", "awk", "chmod", 
                   "find","ln", "netstat","mv", "ssh-keygen", "wget", "curl", "busybox",
                   "tar", "chown","date","dd","dmesg","egrep","fgrep","gunzip","gzip",
                   "mknod","more","mount","rm","rmdir","sed","true","unmount","usleep"]
# 二进制文件字符串命中个数
